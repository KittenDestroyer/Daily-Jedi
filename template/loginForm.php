<?php  include( "header.php" ); ?>
  <div id="darkSide">
    <form action="admin.php?action=login" method="post" onsubmit="return loginCheck()">
...
<?php  } ?>
    <dl>
      ...
      <dt><label for="password"><?php  echo $globals['PASSWORD']  ?>:</label></dt>
        <dd><input type="password" name="password" id="password" plcaeholder="Admin password" maxlenght="20" /></dd>
    </dl>
  <div>
